...
namespace KP.SmartSoc.Society
{
    public class SocietyManager : ISocietyManager
    {
        ...
        private readonly IRepository<SocietyMember> _societyMemberRepository;
        ...
        public SocietyManager(
            ...
            IRepository<SocietyMember> societyMemberRepository,
        ...
        public async Task<SocietyMember> AddMember(Society society, User user, string HouseNo)
        {
            return await _societyMemberRepository.InsertAsync(SocietyMember.CreateAsync(society, HouseNo, user, _societyMemberAddPolicy));
        }
    ...
    public interface ISocietyManager
    {
        ...
        public Task<SocietyMember> AddMember(Society society, User user, string HouseNo);
