...
{
    public abstract class SmartSocWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SmartSocWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SmartSocWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SmartSocDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SmartSocDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SmartSocDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SmartSocDbContext, Task<T>> func)
        {
            T result;
